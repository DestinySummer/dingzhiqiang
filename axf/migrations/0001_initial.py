# -*- coding: utf-8 -*-
# Generated by Django 1.11.7 on 2018-08-29 09:53
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.IntegerField(choices=[(1, '未付款'), (2, '未发货'), (3, '未收货'), (4, '未评价'), (5, '完成')], default=1, verbose_name='订单状态')),
        ...
        migrations.AlterIndexTogether(
            name='cart',
            index_together=set([('user', 'is_selected')]),
        ),
    ]
